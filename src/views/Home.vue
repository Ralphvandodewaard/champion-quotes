<template>
  <div
    v-if="!loading"
    class="flex flex-col flex-grow items-center gap-12 sm:gap-20 p-8 lg:px-40 lg:pt-32 lg:pb-20"
  >
    <div class="flex flex-col items-center gap-8 w-3/5 lg:w-4/5 max-w-xl">
      <div class="text-2xl text-center font-semibold text-white">
      ...
      >
        ...
        >
          <img v-if="isCorrect" class="h-full w-full" src="../assets/icons/arrow-right.svg">
          <img v-if="!isCorrect" class="h-full w-full" src="../assets/icons/reset.svg">
        </button>
      </div>
    </div>
...
export default class Home extends Vue {
  ...
  get audioSrc(): string {
    return `${this.communitydragonUrl}/11.23.1/champion/19/champ-select/sounds/choose`;
  }
